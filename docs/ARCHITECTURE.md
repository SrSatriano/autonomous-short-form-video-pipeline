# Arquitetura — Pipeline autônomo de vídeos curtos

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Pipeline YAML com estágios medidos e saída 9:16 pronta para publicação.
...
|------------|------------------|
| Pipeline | Pipeline configurável em YAML |
| Legendas | Legendas ASS com word timing |
| NVENC | NVENC / VideoToolbox / AMF |
| Métricas | Métricas por estágio |
| Saída | Saída TikTok/Shorts |
