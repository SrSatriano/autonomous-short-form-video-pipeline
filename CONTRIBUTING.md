...
Obrigado por considerar uma contribuição para **Pipeline autônomo de vídeos curtos**.

## Como começar

1. Faça um fork do repositório [autonomous-short-form-video-pipeline](https://github.com/SrSatriano/autonomous-short-form-video-pipeline).
2. Crie uma branch: `git checkout -b feat/minha-melhoria`
3. Instale dependências conforme o [README](README.md).
4. Execute os testes: `pytest tests/ -q`
